...
export class UserService {
  ...
  async getUserMeta(user: UserEntity, currentUser: UserEntity): Promise<UserMetaDto> {
    return {
      ...
      isProblemAdmin: await this.userPrivilegeService.userHasPrivilege(user, UserPrivilegeType.ManageProblem),
      isContestAdmin: await this.userPrivilegeService.userHasPrivilege(user, UserPrivilegeType.ManageContest),
      isDiscussionAdmin: await this.userPrivilegeService.userHasPrivilege(user, UserPrivilegeType.ManageDiscussion),
